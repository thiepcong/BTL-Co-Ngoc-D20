...
class ApiUrlConstants {
  ...
  static String sendMail = '$baseUrl/api/emailDetail/send';
  ...
  static String unPaidListByAdsress =
      '$baseUrl/api/customer/UnPaidListByAdsress';
  ...
  static String getNewCustomerList = '$baseUrl/api/report/getNewCustomerList';

  static String getNewCustomer = '$baseUrl/api/report/getNewCustomers';

  static String getRevenueList = '$baseUrl/api/report/getRevenueList';
}
